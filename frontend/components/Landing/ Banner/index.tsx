...
export const LandingBanner: React.FC = () => {
    return (
        <div className="relative max-w-[1320px] mx-auto my-8 rounded-xl overflow-hidden bg-gradient-to-r from-[#238CEC] to-[#054279] shadow-lg">
            ...
            <div className="flex items-center justify-between mx-16 mb-6">
                ...
                <div className="flex items-center justify-center">
                    <img
                        src="\images\landing\earphones.png" // Replace with the actual path of your controller image
                        alt="Controller"
                ...
                <div className="flex items-center justify-center pl-4">
                    <img
                        src="\images\landing\controller.png" // Replace with the actual path of your earphones image
                        alt="Earphones"
